...
ActiveRecord::Schema.define(:version => 20131220164702) do
  ...
  add_index "monthly_snapshots", ["office_id"], :name => "index_monthly_snapshots_on_office_id"
  add_index "monthly_snapshots", ["snap_date"], :name => "index_monthly_snapshots_on_snap_date"
  ...
  add_index "project_allowances", ["person_id"], :name => "index_project_allowances_on_person_id"
  add_index "project_allowances", ["project_id"], :name => "index_project_allowances_on_project_id"
